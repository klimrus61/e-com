...
def delete_address(request, id):
    ...
    return redirect("account:addresses")  # simple redirect
...
def set_default(request, id):
    ...
    # Сохранием с какого url поступил запрос

    previous_url = request.META.get("HTTP_REFERER")  # на какой стр мы находились
